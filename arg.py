...
def mutation_args():
    ...
    arg_parser.add_argument("--result_saving_dir", default="../results", type=str)
...
def delta_debugging_args():
    ...
    arg_parser.add_argument("--compiler_path", default="/export/d1/dwxiao/glow-build/bin/model-compiler", type=str)
    arg_parser.add_argument("--input_data_path", default="../data/data.npy", type=str)
    arg_parser.add_argument("--seed_number", default=1, type=int)
